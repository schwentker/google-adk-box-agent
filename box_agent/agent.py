...
# Import sub-agents
from .sub_agents.box_agent_generic import box_generic_agent
from .sub_agents.box_agent_ai import box_ai_agent
...
class BoxFlowAgent(BaseAgent):
    ...
    def __init__(
        ...
        Args:
            ...
            box_generic_agent: An LlmAgent for Box content search.
            box_ai_agent: An LlmAgent for Box hub interactions.
        """
